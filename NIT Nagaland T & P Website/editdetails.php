...
<center>
	<div class="page">
	<div class="header">
        <h1>NATIONAL INSTITUTE OF TECHNOLOGY</h1><br>
	...
	<div class="linkspart"><strong>
		...
		<a href="map.html">Reaching NITN</a>&nbsp
...
<form action="update.php?data=details" method="post"
		...
		<?php 
		$sql = mysql_query("select * from student where regno='$username'");
